      ...
      <div>
        ...
        <nav style={{ backgroundColor: '#F0F3FF', borderBottom: '1px solid #dee2e6', padding: '10px 0' }}>
            <div className="container-fluid d-flex justify-content-between align-items-center">
                ...
                <div className="dropdown ml-auto"  style={{ marginRight: '200px' }}>
                    <Dropdown show={isOpen} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} drop="down"  >
                        <Dropdown.Toggle style={isOpen ? { backgroundColor: '#836FFF', borderColor: '#836FFF', color: 'white',marginLeft: '-60px' } : { backgroundColor: '#F0F3FF', borderColor: '#836FFF', color: 'black',marginLeft: '-60px' }} id="dropdown-basic">
                            Complaint Types
                        </Dropdown.Toggle>
                        <Dropdown.Menu >
                        ...
                        <Dropdown.Item value="Safety" style={{color:"#333333"}}>Safety</Dropdown.Item>
