...
function SignInRector() {
  ...
  useEffect(() => {
    // Set a timeout to show icons after 0.5 seconds
            ...
            <Form className="w-50">
              ...
              <Form.Group>
                <div className="d-flex justify-content-center mb-1" style={{ marginTop: "-30px", opacity: showIcons ? 1 : 0, transition: "opacity 0.5s ease-in" }}>
                  <Link to="/signIn/rector" className="icon-link" onClick={() => handleRedirect("/signIn/rector")} style={{ marginRight: "10px", borderRadius: "50%", display: "inline-flex", alignItems: "center", justifyContent: "center", height: "80px", width: "80px", transition: "backgroundColor 0.3s", textDecoration: "none" }}><AccountCircleIcon style={{ height: "60px", width: "60px", color: path === "/signIn/rector" ? "#836FFF" : "#89817f" }} /></Link>
                  <Link to="/signIn/student" aria-current="page" className="icon-link" onClick={() => handleRedirect("/signIn/student")} style={{ backgroundColor: "#89817f", opacity: 1, transition: "opacity 1s ease", marginLeft: "-5px", borderRadius: "50%", display: "inline-flex", alignItems: "center", justifyContent: "center", height: "52px", width: "52px", marginTop: '15px', transition: "backgroundColor 0.3s", transition: "transform 0.5s ease", textDecoration: "none" }}><SchoolIcon style={{ height: "38px", width: "38px", color: "white" }} /></Link>
                </div>
              </Form.Group>
              ...
              <Form.Group className="mb-3" controlId="formBasicPassword">
                ...
                <Form.Control
                  ...
                  endAdornment={<InputAdornment position="end"><EnhancedEncryptionIcon /></InputAdornment>}
                />
              </Form.Group>
              {error && <div className="mt-3 text-center"><div className="text-danger error-message">{error}</div></div>}
