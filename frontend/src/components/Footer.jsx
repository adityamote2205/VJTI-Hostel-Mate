            ...
            <div className="row gy-4 gy-lg-0 justify-content-xl-between">
              ...
              <div className="col-12 col-md-4 col-lg-3 col-xl-2">
                <div className="widget">
                  ...
                  <address className="mb-4">VJTI Hostels , Mumbai</address>
                  <p className="mb-1">
                    <a className="link-secondary text-decoration-none" href="tel:+15057922430">(+91) 7057041764</a>
                  </p>
                  <p className="mb-0">
                    <a className="link-secondary text-decoration-none" href="mailto:demo@yourdomain.com">pjkhabale_b21@et.vjti.ac.in</a>
                  </p>
                </div>
              </div>
              <div className="col-12 col-md-4 col-lg-3 col-xl-2">
              ...
              <div className="col-12 col-md-4 col-lg-3 col-xl-2">
                <div className="widget">
                  ...
                  <ul className="list-unstyled">
                    <li className="mb-2">
                      <a href="/aboutUs" className="link-secondary text-decoration-none">Developers</a>
                    </li>
                    <li className="mb-2">
                      <a href="/aboutUs" className="link-secondary text-decoration-none">Goal</a>
                    </li>
                  </ul>
                </div>
              </div>
